...
DEFAULT_OBJC_FLAGS = ["-ObjC", "-fobjc-gc", "-fconstant-string-class=NSConstantString"]
DEFAULT_OBJC_LDFLAGS = ["-lobjc", "-lgnustep-base"]
...
"""
    ...
    def get_flags(self) -> List[str]:
        return (self.runtime_dict.get('objc_flags') or DEFAULT_OBJC_FLAGS) + super().get_flags()

    def get_ldflags(self) -> List[str]:
        return (self.runtime_dict.get('objc_ldflags') or DEFAULT_OBJC_LDFLAGS) + super().get_ldflags()
